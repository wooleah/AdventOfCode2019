...
function getOutput(input) {
  ...
  while(inputArr[instructionPointer] !== opcode.HALT) {
    ...
    input1Pos = opcodeInput[opcodeInput.length - 3] === paramMode.IMMEDIATE 
      ? instructionPointer + 1 
      : inputArr[instructionPointer + 1];
    input2Pos = opcodeInput[opcodeInput.length - 4] === paramMode.IMMEDIATE 
    ...
    switch (opcodeProtocol) {
      case opcode.INPUT:
        inputArr[inputArr[instructionPointer + 1]] = AIR_CONDITIONER_UNIT_ID;
        nextOpcodePos = 2;
        break;
      case opcode.OUTPUT:
